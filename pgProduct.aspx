...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">  
    ...
    <div class="productPage">            
        <h1 style="text-align: center">Trophies, Tee-shirts, and Plaques</h1>
    
        <div class="trophy" style="height:650px; width:1200px; margin:auto; padding:25px; border:solid">
            <h2>Trophies</h2>
       ...
       <div class="Teeshirt" style="height:640px; width:1200px; margin:auto; padding:25px; border:solid; margin-top:5px">
           <h2>Tee shirts</h2>
        ...
        <div class="plaques" style="height:600px; width:1200px; margin:auto; padding:25px; border:solid; margin-top:5px">
