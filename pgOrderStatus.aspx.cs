...
public partial class pgOrderStatus : System.Web.UI.Page
{
    ...
    protected void btnOrderDetails_Click(object sender, EventArgs e)
    {
        ...
        gvOrderDetails.DataKeyNames = new string[] { "OrderID", "ProductID" };
        ...
        DField = new BoundField(); DField.DataField = "ProductID"; DField.HeaderText = "ProductID"; DField.InsertVisible = false; DField.ReadOnly = true; DField.SortExpression = "ProductID"; gvOrderDetails.Columns.Add(DField);
